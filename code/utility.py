...
def create_items_genres_matrix(items_dictionary, dataset_name, dataset_path, items_genres_path):
    if dataset_name == "movielens":
        items_genres = pd.read_csv(os.path.join(dataset_path, "movies.dat"), sep="::", engine="python", header=None,encoding='latin-1')[
            [0, 2]]
...
def get_ratings(dataset_name, dataset_folder):
    if dataset_name == "movielens":
        ...
        df = pd.read_csv(os.path.join(dataset_folder, f"small_matrix.csv"))[
        ...
        filtered_df= pd.read_csv(os.path.join(dataset_folder, "yahoo_small.csv"))
        ratings = filtered_df.to_numpy()

    elif dataset_name == "netflix":
        filtered_df = pd.read_csv(os.path.join(dataset_folder, "netflix_small.csv"))
        ratings = filtered_df.to_numpy()

    elif dataset_name == 'arxiv':
        filtered_df = pd.read_csv(os.path.join(dataset_folder, "ratings.csv"))
        ratings = filtered_df.to_numpy()
